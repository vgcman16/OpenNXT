...
class TlsTerminateProxyTest(unittest.TestCase):
    ...
    def test_create_remote_stream_prioritizes_secure_game_target_over_tls_remote_raw(self) -> None:
        args = SimpleNamespace(
            remote_host="127.0.0.1",
            remote_port=43596,
            tls_remote_host="content.runescape.com",
        ...
        create_connection.assert_called_once_with(("127.0.0.1", 43594), timeout=1.0)
        self.assertIs(remote_stream, fake_remote)
        self.assertEqual(remote_target, "127.0.0.1:43594 (tls passthrough for tls-secure-game)")
